  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none" aria-hidden>
        <div className="absolute -top-48 left-1/2 -translate-x-1/2 w-[900px] h-[700px] rounded-full bg-indigo-600/12 blur-[130px]" />
        <div className="absolute top-1/3 -right-40  w-[500px] h-[500px] rounded-full bg-violet-600/8  blur-[110px]" />
        <div className="absolute bottom-0   -left-40  w-[400px] h-[400px] rounded-full bg-blue-600/8   blur-[100px]" />
      </div>
      ...
      <main className="flex flex-col flex-1">
        ...
        <section className="flex flex-col items-center justify-center pt-36 pb-20 px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-xs font-semibold tracking-widest uppercase mb-8">
            ...
            Planificador con IA para Orlando
          </div>

          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-white leading-[0.95] mb-6 max-w-4xl">
            Tu viaje{' '}
            <span className="bg-gradient-to-r from-blue-400 via-violet-400 to-pink-400 bg-clip-text text-transparent animate-gradient-pan">
              mágico
            </span>
            <br />a Orlando
          </h1>
          ...
          <p className="text-white/40 text-lg md:text-xl max-w-xl mx-auto mb-12 font-medium leading-relaxed">
            Describí cómo querés tus vacaciones y la IA armará el itinerario perfecto, día por día, para toda la familia.
          </p>
